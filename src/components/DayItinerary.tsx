...
const phases = [
    ...
    },
    {
      ...
      icon: TreePine,
      experiences: [
        { nameKey: 'exp.gautirth', path: '/experiences' },
        { nameKey: 'exp.aplegaon', path: '/experiences' },
        { nameKey: 'exp.gaushala', path: '/experiences' },
        { nameKey: 'exp.piccity', path: '/experiences' },
      ],
    ...
    },
    {
      ...
      icon: Heart,
      experiences: [
        { nameKey: 'exp.carnival', path: '/experiences' },
        { nameKey: 'exp.boating', path: '/experiences' },
        { nameKey: 'exp.pixopark', path: '/experiences' },
      ],
    ...
    },
    {
      ...
      icon: Waves,
      experiences: [
        { nameKey: 'exp.shauryavan', path: '/experiences' },
        { nameKey: 'exp.swimmingpool', path: '/experiences' },
        { nameKey: 'exp.waterpark', path: '/experiences' },
      ],
      accent: 'primary' as const,
      illustration: '💦',
    ...
    },
    {
      ...
      icon: Tent,
      experiences: [
        { nameKey: 'exp.tents', path: '/experiences' },
      ],
      accent: 'tertiary' as const,
      illustration: '⛺',
