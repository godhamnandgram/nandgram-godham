...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'exp.aplegaon.desc': 'Step into authentic village life and experience traditional rural Maharashtra.',
    'exp.carnival': 'Carnival Street',
    'exp.carnival.desc': 'A vibrant street filled with games, food stalls, and festive energy.',
